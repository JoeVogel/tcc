...
Devido a isso, foram desenvolvidos dois softwares embarcados, sendo um para cada módulo. Ambos serão descritos nas próximas seções.

\section{Análise do Software do Protótipo}  

Como o software deste protótipo é relativamente simples. A modelagem dele também se torna muito simples. Devido a isso, será demonstrado apenas o diagrama de classe do software  \abrevpuc{UML}{}

\subsection{Fluxograma}

\begin{figure}[h!]
  \centering
  \includegraphics[width=.75\linewidth,height=270pt]{fluxograma.PNG}
  \caption{Fluxograma dos módulos do protótipo.}
...
Na figura XX, podemos ver como ficou o circuito eletrônico.

%\begin{figure}[h!]
%  \centering
%  \includegraphics[width=.75\linewidth,height=270pt]{.PNG}
%  \caption{Circuito eletrônico.}
%  \label{fig_fluxograma}
%\end{figure}
