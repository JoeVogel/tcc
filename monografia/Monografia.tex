...
O Capítulo 2, Fundamentação tem como objetivo deixar o leitor mais familiarizado com a agricultura de precisão, tratores agrícolas, tipos de sensores que serão utilizados, plataforma Arduino e padrões de comunicação RF, entre outras informações pertinentes. Estas serão divididas em seções a fim de facilitar a leitura e o entendimento. 
...
\begin{figure}[H]
  ...
  \caption{Trecho do programa responsável por montar o pacote de dados para envio.}
